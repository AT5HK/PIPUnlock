...
-(BOOL)interactionControllerUseSystemGesturesForResizing:(id)arg0  {BOOL r = %orig; return r; }
...
-(void)containerViewControllerDidEndInteraction:(id)arg0  { %log; %orig; }
...
-(void)containerViewController:(id)arg0 didUpdateStashState:(BOOL)arg1 springSettings:(id)arg2  { %log; %orig; }
